...
class PlaylistFeature {
    ...
    fun displayListOfPlaylist() {
        ...
        onView(allOf(withId(R.id.playlist_name), isDescendantOfA(childOf(withId(R.id.playlist_list), 0))))
            .check(matches(withText("Hard Rock Cafe")))
            .check(matches(isDisplayed()))

        onView(allOf(withId(R.id.playlist_category), isDescendantOfA(childOf(withId(R.id.playlist_list), 0))))
